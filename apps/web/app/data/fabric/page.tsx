...
const workspaces: FabricWorkspace[] = [
  {
    ...
    items: [
      {
        id: "lh-engagement-delivery-gold",
        name: "engagement-delivery-gold",
        type: "lakehouse",
        status: "active",
        lastRefresh: "10 min ago",
        description: "Gold-layer lakehouse for curated Engagement Delivery data including transactions, compliance verification, and findings.",
        tags: ["professional-services", "gold-layer"],
      },
      {
        id: "lh-engagement-delivery-bronze",
        name: "engagement-delivery-bronze",
        type: "lakehouse",
        status: "active",
        lastRefresh: "1 hr ago",
        description: "Raw ingestion lakehouse receiving ERP exports and counterparty feeds.",
        tags: ["raw", "ingestion"],
      },
      {
        id: "wh-engagement-delivery-dw",
        name: "engagement-delivery-datawarehouse",
        type: "warehouse",
        status: "active",
      ...
      {
        id: "nb-exploration",
        name: "Engagement Delivery Data Exploration",
        type: "notebook",
        status: "active",
        lastRefresh: "2 days ago",
        description: "Shared Spark notebook for ad-hoc analysis of Engagement Delivery data.",
      },
      {
        id: "rpt-findings",
        name: "Finding Analytics Dashboard",
        type: "report",
        status: "active",
        lastRefresh: "1 hr ago",
        description: "Power BI report tracking finding trends, reason codes, and recovery rates.",
        tags: ["finding", "powerbi"],
      },
      {
        id: "sm-engagement-delivery",
        name: "Engagement Delivery Semantic Model",
        type: "semantic-model",
        status: "active",
        lastRefresh: "1 hr ago",
        description: "Unified semantic model exposing transactions, engagements, and engagements for AI queries.",
    ...
    items: [
      {
        ...
        description: "Feature store for model training — transactions-level features and engagement risk scores.",
        tags: ["features", "ml"],
      },
      {
        id: "pl-features",
        ...
        status: "paused",
        lastRefresh: "2 days ago",
        description: "Computes and materialises features for going concern risk models.",
        tags: ["ml", "pipeline"],
      },
    ],
  },
