...
type Category = "professional-services" | "nlp" | "tabular" | "vision" | "multimodal" | "finance" | "synthetic" | "benchmark"
...
const datasets: Dataset[] = [
  {
    id: "audit-transactions-engagement-delivery-v3",
    name: "GL Entries & Findings (Engagement Delivery v3)",
    org: "Professional Services",
    description: "4.1M de-identified transactions with finding codes, remark codes, and remediation outcomes. Ideal for going concern risk and approval workflow models.",
    category: "professional-services",
    modality: "tabular",
    task: "classification",
    tags: ["transactions", "finding", "Engagement Delivery", "independence-safe", "professional-services"],
    size: "4.2 GB",
  ...
  {
    id: "risk-compliance-verification-counterparty",
    name: "Compliance Verification Checks",
    org: "Professional Services",
    description: "2.8M compliance verification records across 40+ counterparties with real-time vs batch outcomes. Use for compliance verification agent training.",
    category: "professional-services",
    modality: "tabular",
    task: "classification",
    tags: ["compliance verification", "counterparty", "Engagement Delivery"],
    size: "1.8 GB",
  ...
  {
    id: "audit-nlp-financial-memos",
    name: "Professional Services NLP Corpus v2",
    org: "Enterprise AI",
    description: "450K de-identified financial memos with IFRS/GAAP annotations, NER labels, and memo structure. Benchmark for financial NLP models.",
    category: "nlp",
    modality: "text",
    task: "named-entity-recognition",
    tags: ["financial", "NLP", "IFRS/GAAP", "NER", "COSO"],
    size: "2.1 GB",
  ...
  {
    id: "tax-approval-workflow-requests",
    name: "Prior Approval Request Corpus",
    org: "Professional Services",
    description: "512K approval workflow requests with approval/finding labels, control codes, and financial justification notes.",
    category: "professional-services",
    modality: "multimodal",
    task: "classification",
    tags: ["prior-approval", "approval", "control-codes"],
    size: "890 MB",
  ...
  {
    id: "nlp-tax-summarization",
    name: "Tax Memo Summary",
    org: "Professional Services NLP",
    description: "88K tax technical memoranda paired with human-written abstracts. Use for summarization fine-tuning or ROUGE evaluation.",
    category: "nlp",
    modality: "text",
    task: "summarization",
    tags: ["summarization", "financial", "tax memo", "abstractive"],
    size: "1.1 GB",
  ...
  {
    id: "tabular-gaap-control-codes",
    name: "IFRS/GAAP Control Codes 2026",
    org: "Deloitte Audit",
    description: "Complete 2026 IFRS/GAAP financial assertion and control testing code tables with descriptions, hierarchy, and materiality flags.",
    category: "tabular",
    modality: "tabular",
    task: "classification",
    tags: ["IFRS/GAAP", "financial assertion", "control", "reference"],
    size: "42 MB",
  ...
  {
    id: "tabular-engagement-registry",
    name: "Deloitte Engagement Registry",
    org: "Deloitte Audit",
    description: "Full Engagement ID registry snapshot with engagement type, taxonomy, specialties, address, and active status. Updated monthly.",
    category: "tabular",
    modality: "tabular",
    task: "retrieval",
    tags: ["engagement-id", "engagement", "registry", "Deloitte"],
    size: "380 MB",
  ...
  {
    id: "synth-transactions-benchmark",
    name: "Synthetic Transactions Benchmark",
    org: "Enterprise AI",
    description: "500K fully synthetic transactions generated with differential privacy guarantees. Safe for model evaluation and CI pipelines.",
    category: "synthetic",
    modality: "tabular",
    task: "benchmark",
  ...
  {
    id: "nlp-finding-reason-classification",
    name: "Finding Reason Classifier",
    org: "Professional Services",
    description: "48K labeled finding notes mapped to finding taxonomy reason codes for multi-class classification fine-tuning.",
    category: "nlp",
    modality: "text",
    task: "classification",
    tags: ["finding", "taxonomy", "root-cause", "classification", "NLP"],
    size: "158 MB",
  ...
  {
    id: "vision-ESG-cxr",
    name: "ESG Satellite Imagery Benchmark",
    org: "Deloitte ESG",
    description: "112K satellite and facility images with emissions, land-use, and asset-condition labels. Standard benchmark for ESG and climate-risk AI.",
    category: "vision",
    modality: "image",
    task: "classification",
    tags: ["ESG", "satellite-imagery", "imaging", "Deloitte ESG", "benchmark"],
    size: "42 GB",
  ...
  {
    id: "fin-advisory-spend",
    name: "Professional Services Spend Analytics",
    org: "Deloitte Insight",
    description: "Aggregated counterparty-adviser spend data from Deloitte AdvisoryBench (2019–2023) for cost trend analysis and financial risk modeling.",
    category: "finance",
    modality: "tabular",
    task: "regression",
    tags: ["spend", "cost", "Deloitte Insight", "counterparty"],
    size: "2.8 GB",
  ...
  {
    id: "bench-engagement-delivery-eval",
    name: "Engagement Delivery Agent Eval Suite",
    org: "Enterprise AI",
    description: "2,400 expert-annotated Q&A pairs for evaluating professional services agents across compliance verification, tax classification, and finding categories.",
    category: "benchmark",
    modality: "text",
    task: "question-answering",
    tags: ["benchmark", "eval", "agent", "Engagement Delivery", "QA"],
    size: "18 MB",
  ...
  {
    id: "nlp-control-objective-descriptions",
    name: "Control Objective Descriptions",
    org: "COSO (mirrored)",
    description: "Control objective descriptions and regulatory context for embedding and code lookup tasks.",
    category: "tabular",
    modality: "text",
    task: "retrieval",
    tags: ["control objective", "control", "coding", "COSO"],
    size: "64 MB",
  ...
  {
    id: "synth-engagement-segment-attributes",
    name: "Synthetic Engagement Segment Attributes",
    org: "Enterprise AI",
    description: "1M synthetic engagement profiles with segment attributes, risk scores, and control maturity indicators. Privacy-safe for integration testing.",
    category: "synthetic",
    modality: "tabular",
    task: "benchmark",
    tags: ["synthetic", "engagements", "segment attributes", "risk"],
    size: "480 MB",
      ...
      <main className="app-shell-offset p-6">
        ...
        <div className="mb-8 rounded-2xl border border-sky-500/20 bg-gradient-to-br from-sky-500/10 via-background to-violet-500/5 p-8">
          ...
          <p className="mb-6 max-w-xl text-sm text-muted-foreground">
            Curated, governed professional-services datasets ready for model training, evaluation, and agent orchestration.
          ...
          <div className="mt-4 flex gap-6 text-sm text-muted-foreground">
            ...
            <span><strong className="text-foreground">independence-safe</strong> de-identification guaranteed</span>
          </div>
        </div>
