...
// Get category badge color - Enterprise brand aligned
...
export function ContributeCard() {
  return (
    <div className="flex h-full flex-col items-center justify-center rounded-lg border border-dashed border-[var(--accent)]/30 bg-card/50 p-6 text-center">
      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-[var(--accent)]/10">
        <svg viewBox="0 0 24 24" className="h-8 w-8 text-[var(--accent)]" fill="currentColor">
