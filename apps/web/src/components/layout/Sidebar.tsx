...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    title: "Registry",
    items: [
      { href: "/registry", label: "MCP Servers", icon: Server },
      { href: "/registry/agents", label: "A2A Agents", icon: Boxes },
      { href: "/registry/skills", label: "Skills", icon: Lightbulb },
    ],
  },
  {
    title: "Orchestration",
    items: [
      { href: "/orchestration/templates", label: "Templates", icon: LayoutTemplate },
      { href: "/orchestration/executions", label: "Executions", icon: CirclePlay },
    ],
  },
  {
    title: "Governance",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/iam", label: "IAM", icon: KeyRound },
      { href: "/admin/security", label: "Security Scans", icon: ScanSearch },
