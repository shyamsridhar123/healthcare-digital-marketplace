...
const MODEL_METADATA: Record<string, {
  ...
  "model-gpt4o": {
    arch: "GPT-4o multimodal transformer, vision + audio + text, tuned for professional services",
    cutoff: "April 2024",
    benchmarks: [
      { name: "LegalBench",  score: 90.2, dataset: "LegalBench tasks",    date: "2025-10-01" },
      { name: "FinQA",   score: 91.5, dataset: "MMLU Pro",           date: "2025-10-01" },
      { name: "TaxQA",         score: 84.1, dataset: "TaxQA Dev",        date: "2025-10-01" },
      { name: "Contract OCR",  score: 95.3, dataset: "Internal engagement set",   date: "2025-10-01" },
    ],
    intendedUse: ["Complex advisory reasoning", "Multimodal document analysis", "Client inquiry triage support", "Engagement workflow orchestration"],
  },
  "model-gpt5chat": {
    arch: "GPT-5 decoder-only transformer, 200B+ params, RLHF-tuned for instruction following",
    cutoff: "January 2026",
    benchmarks: [
      { name: "LegalBench",  score: 93.1, dataset: "LegalBench tasks",    date: "2026-01-15" },
      { name: "FinQA",   score: 94.6, dataset: "MMLU Pro",           date: "2026-01-15" },
      { name: "Advisory Chat Eval",     score: 96.2, dataset: "Internal chat eval", date: "2026-01-15" },
    ],
    intendedUse: ["Client intake conversations", "Regulatory Q&A systems", "Service navigation bots", "Multi-turn advisory coaching"],
  },
  "model-gpt52": {
    ...
    benchmarks: [
      { name: "LegalBench",  score: 94.3, dataset: "LegalBench tasks",    date: "2026-02-01" },
      { name: "Hallucination",   score: 97.8, dataset: "TruthfulQA Pro",    date: "2026-02-01" },
      { name: "FinQA",   score: 95.2, dataset: "MMLU Pro",           date: "2026-02-01" },
    ],
    intendedUse: ["Engagement documentation", "Standards-based Q&A", "Professional-services content generation", "Quality-critical workflows"],
  },
  "model-gpt5mini": {
    arch: "GPT-5 Mini — distilled 7B decoder, low-latency, optimised for structured outputs",
    cutoff: "December 2025",
    benchmarks: [
      { name: "LegalBench",  score: 82.1, dataset: "LegalBench tasks",    date: "2025-12-01" },
      { name: "Transaction Test",     score: 94.5, dataset: "Internal audit set",  date: "2025-12-01" },
      { name: "Control Extraction", score: 91.3, dataset: "SOX control benchmark",  date: "2025-12-01" },
    ],
    intendedUse: ["High-throughput transaction testing", "Independence checks", "Control extraction from workpapers", "Batch engagement processing"],
  },
  "model-gpt5codex": {
    arch: "GPT-5 Codex — code-specialized decoder with ERP and regulatory vocabulary fine-tuning",
    cutoff: "November 2025",
    benchmarks: [
      { name: "ERP Schema Gen",    score: 96.4, dataset: "ERP integration test suite", date: "2025-11-15" },
      { name: "EDI Message Parse",  score: 94.8, dataset: "Internal EDI set",   date: "2025-11-15" },
      { name: "HumanEval (Python)", score: 88.2, dataset: "HumanEval",          date: "2025-11-15" },
    ],
    intendedUse: ["ERP integration code generation", "EDI message parsing", "Advisory API scaffolding", "Audit automation scripts"],
  },
  "model-o1": {
    arch: "o1 chain-of-thought LLM with extended reasoning tokens and verification steps",
    cutoff: "September 2024",
    benchmarks: [
      { name: "LegalBench",  score: 91.8, dataset: "LegalBench tasks",    date: "2025-09-01" },
      { name: "GPQA Diamond",    score: 78.3, dataset: "GPQA Diamond",      date: "2025-09-01" },
      { name: "RiskStep Eval",   score: 89.6, dataset: "Risk assessment",   date: "2025-09-01" },
    ],
    intendedUse: ["Risk assessment support", "Regulatory policy interpretation", "Multi-step engagement reasoning", "Audit trail generation"],
  },
  "model-deepseek-r1": {
    arch: "DeepSeek R1 — 671B MoE open-source reasoner with visible chain-of-thought",
    cutoff: "May 2025",
    benchmarks: [
      { name: "LegalBench",  score: 87.4, dataset: "LegalBench tasks",    date: "2025-06-01" },
      { name: "TaxQA",         score: 80.9, dataset: "TaxQA Dev",       date: "2025-06-01" },
      { name: "COT Faithfulness", score: 92.1, dataset: "Internal eval",    date: "2025-06-01" },
    ],
    intendedUse: ["Explainable advisory decision support", "Professional benchmark evaluation", "Open-weight research", "Audit-ready reasoning chains"],
  },
  "model-gpt-oss-120b": {
    arch: "GPT OSS 120B — open-weight dense transformer, on-premise deployable, no telemetry",
    cutoff: "October 2025",
    benchmarks: [
      { name: "LegalBench",  score: 85.6, dataset: "LegalBench tasks",    date: "2025-10-15" },
      { name: "FinQA",   score: 86.3, dataset: "MMLU Pro",           date: "2025-10-15" },
      { name: "Air-gap Perf",    score: 99.9, dataset: "Internal uptime",   date: "2025-10-15" },
    ],
    intendedUse: ["Air-gapped client deployments", "On-premise SOC 2 compliance", "Zero-egress advisory AI", "Private cloud deployments"],
  },
  "model-gpt4": {
    arch: "GPT-4 dense transformer, 1.8T params, RLHF, context window 128k tokens",
    cutoff: "April 2023",
    benchmarks: [
      { name: "LegalBench",  score: 86.1, dataset: "LegalBench tasks",    date: "2025-08-01" },
      { name: "FinQA",   score: 88.4, dataset: "MMLU Pro",           date: "2025-08-01" },
      { name: "ContractNLI",        score: 79.5, dataset: "ContractNLI Test",         date: "2025-08-01" },
    ],
    intendedUse: ["Engagement note summarization", "ERP Q&A", "Engagement documentation", "Multi-language professional-services content"],
  },
  "model-gpt41": {
    arch: "GPT-4.1 — 256k token context, improved long-document recall and instruction adherence",
    cutoff: "October 2024",
    benchmarks: [
      { name: "LegalBench",  score: 88.7, dataset: "LegalBench tasks",    date: "2025-09-15" },
      { name: "Contract Recall",  score: 93.2, dataset: "Contract corpus",        date: "2025-09-15" },
      { name: "FinQA",   score: 90.1, dataset: "MMLU Pro",           date: "2025-09-15" },
    ],
    intendedUse: ["Extended client history analysis", "Multi-document engagement summarization", "Long-form audit workpapers", "Comprehensive contract review"],
  },
  "model-gpt35turbo": {
    arch: "GPT-3.5 Turbo — 20B param decoder, optimised for chat and structured classification",
    cutoff: "September 2021",
    benchmarks: [
      { name: "LegalBench",  score: 68.4, dataset: "LegalBench tasks",    date: "2025-06-01" },
      { name: "Finding Route Acc", score: 91.2, dataset: "Internal audit set",  date: "2025-06-01" },
      { name: "Independence Acc", score: 93.5, dataset: "Internal eval",     date: "2025-06-01" },
    ],
    intendedUse: ["High-volume independence lookups", "Finding status routing", "Basic triage and routing", "Cost-efficient batch processing"],
  },
  "model-mistral-docai": {
    arch: "Mistral Document AI 2505 — LayoutLM + vision encoder fine-tuned on 50M+ professional-services forms",
    cutoff: "April 2025",
    benchmarks: [
      { name: "Invoice F1",    score: 97.3, dataset: "AP invoice test set", date: "2025-05-15" },
      { name: "Purchase Order F1",        score: 96.8, dataset: "PO test set",    date: "2025-05-15" },
      { name: "Contract Extraction",  score: 95.1, dataset: "Internal engagement set",  date: "2025-05-15" },
      { name: "DocVQA",          score: 93.7, dataset: "DocVQA Test",        date: "2025-05-15" },
    ],
    intendedUse: ["Invoice / purchase order form extraction", "Contract and ERP record parsing", "Counterparty record recognition", "Advisory packet digitization"],
  },
  "model-gptimage15": {
    arch: "GPT Image 1.5 — diffusion + vision encoder hybrid, 2B params, business document fine-tuned",
    cutoff: "November 2025",
    benchmarks: [
      { name: "Control Evidence Assessment", score: 88.9, dataset: "Control evidence bench",  date: "2025-12-01" },
      { name: "Workpaper Annotation", score: 91.4, dataset: "Audit report set",   date: "2025-12-01" },
      { name: "Client Diagram",   score: 94.2, dataset: "Business diagram eval",     date: "2025-12-01" },
    ],
    intendedUse: ["Audit report annotation", "Control evidence image assessment", "Client-facing process diagrams", "Business image Q&A"],
  },
  "model-gpt4omini-rt": {
    arch: "GPT-4o Mini Realtime — streaming audio-text transformer, <300ms latency",
    cutoff: "September 2024",
    benchmarks: [
      { name: "Transcription WER",  score: 97.2, dataset: "Engagement speech", date: "2025-10-01" },
      { name: "Note Accuracy",      score: 92.8, dataset: "Meeting doc eval", date: "2025-10-01" },
      { name: "Latency p95 (ms)",  score: 98.0, dataset: "Internal latency",  date: "2025-10-01" },
    ],
    isVoice: true,
    intendedUse: ["Ambient engagement documentation", "Client service bots", "Real-time transcription", "Voice-driven CRM updates"],
  },
  "model-gpt4omini-tts": {
    ...
    benchmarks: [
      ...
      { name: "Regulatory Terms",  score: 94.1, dataset: "Regulatory pronunciation",    date: "2025-11-15" },
    ],
    isVoice: true,
    intendedUse: ["Engagement reminder calls", "Policy instruction narration", "Advisory plan audio delivery", "Multilingual client communication"],
  },
  "model-ada002": {
    arch: "text-embedding-ada-002 — 1536-dim dense encoder, optimised for semantic similarity",
    cutoff: "September 2021",
    benchmarks: [
      { name: "SOX-Bench",   score: 76.4, dataset: "SOX-Bench",     date: "2025-06-01" },
      { name: "ContractNLI Retrieval",     score: 71.2, dataset: "ContractNLI",            date: "2025-06-01" },
      { name: "Code Retrieval",  score: 80.1, dataset: "CodeSearchNet",      date: "2025-06-01" },
    ],
    isEmbedding: true,
    intendedUse: ["Regulatory semantic search", "RAG over ERP records", "SOX/control code retrieval", "Duplicate transaction detection"],
  },
  "model-embed3small": {
    arch: "text-embedding-3-small — 1536-dim encoder (256-dim truncatable), Matryoshka training",
    cutoff: "November 2023",
    benchmarks: [
      { name: "SOX-Bench",   score: 81.3, dataset: "SOX-Bench",     date: "2025-08-01" },
      { name: "ContractNLI Retrieval",     score: 76.5, dataset: "ContractNLI",            date: "2025-08-01" },
      { name: "Transaction Similarity",score: 88.2, dataset: "Internal audit set",  date: "2025-08-01" },
    ],
    isEmbedding: true,
    intendedUse: ["Real-time independence RAG", "Transaction similarity scoring", "Semantic code search", "Professional knowledge retrieval"],
  },
  "model-embed3large": {
    arch: "text-embedding-3-large — 3072-dim encoder, best-in-class semantic fidelity",
    cutoff: "November 2023",
    benchmarks: [
      { name: "SOX-Bench",   score: 85.7, dataset: "SOX-Bench",     date: "2025-08-01" },
      { name: "ContractNLI Retrieval",     score: 81.9, dataset: "ContractNLI",            date: "2025-08-01" },
      { name: "ERP Retrieval",  score: 93.4, dataset: "Internal ERP set", date: "2025-08-01" },
    ],
    isEmbedding: true,
    intendedUse: ["Professional-services knowledge graph retrieval", "Complex ERP resource lookup", "High-precision regulatory concept matching", "Multi-hop RAG pipelines"],
  },
}
...
function getMockModelCard(modelId: string): ModelCardData {
  ...
  const defaultBenchmarks: BenchmarkResult[] = [
    { name: "LegalBench",  score: 80.0, dataset: "LegalBench tasks", date: "2025-10-01" },
    { name: "FinQA",   score: 82.0, dataset: "MMLU Pro",        date: "2025-10-01" },
  ]
  ...
  return {
    ...
    intendedUse: meta?.intendedUse ?? [
      "Professional-services NLP and reasoning",
      "Engagement documentation processing",
      "Audit automation workflows",
      "Compliant data handling",
    ],
    outOfScope: [
      "Real-time client advice without engagement-lead oversight",
      "Material regulatory decision-making systems without review",
      "Direct client-facing professional advice without review",
    ],
    evaluationMetrics,
    safetyMetrics,
    benchmarks: meta?.benchmarks ?? defaultBenchmarks,
    limitations: [
      "Evaluated primarily on English-language engagement documents",
      "Performance may vary on specialized regulatory domains",
      "Requires SOC 2-compliant data handling in customer environments",
    ],
