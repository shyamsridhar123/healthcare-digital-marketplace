...
// Model data for the marketplace
const models = [
  {
    id: "model-1",
    ...
    description: "Healthcare-specialized language model fine-tuned on clinical notes and RCM documentation for superior healthcare NLP tasks.",
    category: "NLP",
    type: "internal",
    status: "production",
    rating: 4.9,
  ...
  },
  {
    ...
    publisherVerified: true,
    description: "Predicts claim denial probability and recommends corrective actions before submission. Trained on 10M+ claims.",
    category: "Prediction",
    type: "internal",
    status: "production",
    rating: 4.8,
  ...
  },
  {
    ...
    publisher: "Azure AI",
    publisherVerified: true,
    description: "Computer vision model for medical document extraction including EOBs, claims forms, and clinical records.",
    category: "Vision",
    type: "partner",
    status: "production",
    rating: 4.7,
  ...
  },
  {
    ...
    publisherVerified: true,
    description: "Automated ICD-10 and CPT code suggestion from clinical documentation with compliance validation.",
    category: "NLP",
    type: "partner",
    status: "production",
    rating: 4.6,
  ...
  },
  {
    ...
    description: "Optimizes payment posting and identifies underpayment patterns using historical ERA/EOB data analysis.",
    category: "Analytics",
    type: "internal",
    status: "beta",
    rating: 4.4,
  ...
  },
  {
    ...
    publisherVerified: true,
    description: "Named entity recognition for patient matching and record linkage across disparate healthcare systems.",
    category: "NLP",
    type: "internal",
    status: "review",
    rating: 4.3,
